...
function [leftEnd,rightEnd] = slopeChangeEnds(imageArray,figureHandle,frameOfInterest);
...
leftEnd = xxFine2(diff1_zeroCrossing);

diff1_zeroCrossing = find(diff1Vals-(threshFrac.*negativePeakVal)>0,1,'last');
rightEnd = xxFine2(diff1_zeroCrossing);
